...
\cite{zeng-2011,bbb-2013,yang-2013,kim-2014,han-2014,carminati-2014,yang-2014,lakshmanan-2009}:
 Adopting wrong quantifications of jitters \jj{Maolin: name all the equations/theorems}& See
...
\hline
\multirow{2}{*}{Open Issues} &  \cite{DBLP:conf/ecrts/Devi03}: Theorem 8 in \cite{DBLP:conf/ecrts/Devi03} has no proof & ?& ?\\
\cline{2-4}
