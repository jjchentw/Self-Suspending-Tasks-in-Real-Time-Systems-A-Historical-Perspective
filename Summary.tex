...
This review extensively references errata reports as follows:
...
For brevity, these errata reports are only summarized in
...
We would like to conclude this review paper by providing some positive
...
document, in addition to the potential solutions listed in
Table~\ref{tab:summary}, for the affected papers and statements, 
we have not reached any concrete concerns of correctness for
the following results.

*****************\\
\textbf{Please clarify the above sentence. Are the below a list of concerns? are they a list of unproved results?}\\
*****************\\
