...
This section reviews the hardness for designing scheduling algorithms and schedulability analysis of self-suspending task systems. Table \jj{XXX} summarizes the complexity classes of the corresponding problems. \jj{more introductory words...}
