  ...
  \def\uxfpga{0.4cm}
    \scalebox{0.9}{
      \begin{tikzpicture}[x=\uxfpga,y=\uy,auto, thick]
       ...
       \node[anchor=east] at (-0.5, 3.5) {$\tau_3$};
       \node[anchor=east] at (-0.5, 5.5) {$\tau_2$};
       \node[anchor=east] at (-0.5, 7.5) {$\tau_1$};
       ...
       \foreach \x in {0,2,...,22}{
        ...
        \draw[->] (1,0) -- (1,1.75);
        \draw[->] (15,0) -- (15,1.75);
        \draw[dashed,--] (-0.4,0) -- (-0.4,2.25);
        \draw[dashed,--] (22,0) -- (22,2.25);
        \draw[dashed,--] (-0.4,2.25) -- (22,2.25);
        \node[anchor=east] at (13, 1.5) {Processor 1};
        \node[task7, minimum width=\uxfpga, anchor=south west] at (1, 0){\footnotesize};         
        \node[task9, minimum width=3.4*\uxfpga, anchor=south west] at (2, 0){\footnotesize};
        \node[task7, minimum width=\uxfpga, anchor=south west] at (5.4, 0){\footnotesize};
        \node[task7, minimum width=\uxfpga, anchor=south west] at (15, 0){\footnotesize};         
        \node[task9, minimum width=3.4*\uxfpga, anchor=south west] at (16, 0){\footnotesize};
        \node[task7, minimum width=\uxfpga, anchor=south west] at (19.4, 0){\footnotesize};
        
        \draw[->] (6,3) -- (6,4.75);
        \draw[<-,red] (20,3) -- (20,4.2);
        \draw[dashed,--] (-0.4,2.7) -- (-0.4,9.75);
        \draw[dashed,--] (22,2.7) -- (22,9.75);
        \draw[dashed,--] (-0.4,9.75) -- (22,9.75);
        \draw[dashed,--] (-0.4,2.7) -- (22,2.7);
        \node[anchor=east,red] at (21, 4.5) {miss};
        
        \draw[->] (0,5) -- (0,6.75);
        \draw[->] (13,5) -- (13,6.75);
        \draw[--] (2.55,5.3) -- (5.5,5.3);
        \draw[--] (2.55,5.5) -- (5.5,5.5);
        \draw[--] (2.55,5.7) -- (5.5,5.7);
        \node[task7, minimum width=0.1*\uxfpga, anchor=south west] at (2, 5){\footnotesize};         
        \node[task9, minimum width=0.1*\uxfpga, anchor=south east] at (6, 5){\footnotesize};
        \node[task7, minimum width=4*\uxfpga, anchor=south west] at (8, 5){\footnotesize}; 
        \node[task7, minimum width=0.1*\uxfpga, anchor=south west] at (14, 5){\footnotesize};         
        \node[task9, minimum width=0.1*\uxfpga, anchor=south west] at (14.5, 5){\footnotesize};
        \node[task7, minimum width=3*\uxfpga, anchor=south west] at (15.05, 5){\footnotesize};
        \node[task7, minimum width=0.8*\uxfpga, anchor=south west] at (20, 5){\footnotesize};
        ...
        \node[task7, minimum width=2*\uxfpga, anchor=south west] at (0, 7){\footnotesize};
        \node[task7, minimum width=2*\uxfpga, anchor=south west] at (6, 7){\footnotesize};
        \node[task7, minimum width=2*\uxfpga, anchor=south west] at (12, 7){\footnotesize};
        \node[task7, minimum width=2*\uxfpga, anchor=south west] at (18, 7){\footnotesize};
