...
\end{itemize}
The analysis, presented in \cite{LR:rtas10}, is based on the notion of critical instant, \ie, an instant at which, considering the state of the system, an execution request for $\tau_k$ will generate the largest response time. This critical instant was defined as follows:
\begin{itemize}
...
\subsubsection{A counterexample to the synchronous release}
...
{\bf Consequence:} To conclude, the synchronous release of all tasks does not necessarily generate the maximum interference for the self-suspending task $\tau_k$ and is thus not always a critical instant for $\tau_k$. 
...
\centering
 ...
 \hline
        ...
        \hline
    \end{tabular} 
    \caption{Task parameters for the counter-example to the maximization of the number of releases.}
