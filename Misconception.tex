...
Scenario~1 is depicted in Fig.~\ref{fig:ex_crit_inst2sc1}, and Scenario~2 in Fig.~\ref{fig:ex_crit_inst2sc2}. The first $765$ time units are omitted in both figures. This is mainly due to space constraint. In both scenarios, the schedule of the jobs is identical in this initial time window.  
