...
This section presents several misconceptions in some existing results by exploiting concrete examples to demonstrate the potential overstatements. These examples are constructed cases by cases. Therefore, each misconception will be explained by using one specific example. 
