...
Complex cyber-physical systems (\ie advanced embedded real-time computing systems) have \emph{timeliness} requirements over computation such that associated deadlines must be met (\eg for safety-critical systems). Appropriate analytical techniques have been developed that enable \emph{a priori} guarantees to be established over timing behaviour at run-time regarding task deadlines.  
