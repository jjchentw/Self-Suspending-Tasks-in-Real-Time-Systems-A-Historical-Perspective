...
We here demonstrate the reasons to consider self-suspending task systems by using the following six examples.
...
{\bf Example 6: Use of GPUs as accelerators for highly parallelisable workloads}
