...
\subfloat[Use FPGA in parallel (suspension aware)]{
    \scalebox{0.8}{
      \begin{tikzpicture}[x=\uxfpga,y=\uy,auto, thick]
       ...
       \draw[->](0, 6.5) -- (0, 7.2) node[anchor=south]{\footnotesize $\tau_1$ arrives};
       \draw[->](4, 6.5) -- (4, 7.2) node[anchor=south, yshift=0.3cm]{\footnotesize $\tau_2$ arrives};
       \draw[->](8, 6.5) -- (8, 7.2) node[anchor=south]{\footnotesize $\tau_3$ arrives};
