...
\centering
 ...
 \hline
        ...
        \hline
    \end{tabular} 
    \caption{Examples for dynamic segmented-suspending tasks to be used in Section~\ref{sec:review}.}
