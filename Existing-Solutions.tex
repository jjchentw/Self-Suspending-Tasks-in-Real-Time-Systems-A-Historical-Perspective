...
\cline{2-6}
& release jitter (Sec.~\ref{sec:model-interfering-jitter})& Ming \cite{MingLiRTCSA1994} (1994), Kim et al. \cite{RTCSA-KimCPKH95}  (1995), Audsley and Bletsas~\cite{ECRTS-AudsleyB04,RTAS-AudsleyB04} (2004)& \multicolumn{2}{l|}{Bletsas and Audsley~\cite{RTCSA-BletsasA05} (2005)} & Nelissen et al.~\cite[Sec. VI]{ecrts15nelissen} (2015)\\
\cline{2-6}
...
\vspace{0.05in}
 \scalebox{0.65}{
%\setlength{\extrarowheight}{0.1in}
\begin{tabular}{||C{2cm}|C{3.3cm}||C{3cm}|C{3cm}|C{3cm}|C{3cm}|}  
  \hline
  & &\multicolumn{4}{C{12cm}|}{interfered task ($\tau_k$)} \\
\cline{3-6}
& &suspension-oblivious & split & hybrid & critical instant \\
...
\cline{2-6}
& release jitter (Sec.~\ref{sec:model-interfering-jitter})&
\cite{MingLiRTCSA1994},
\cite{RTCSA-KimCPKH95},~\cite{ECRTS-AudsleyB04} \cite{RTAS-AudsleyB04}& \multicolumn{2}{c|}{\cite{RTCSA-BletsasA05}} &\cite[Sec. VI]{ecrts15nelissen}\\
\cline{2-6}
...
\end{tabular}
  ...
  \label{tab:summary-methods-chornical}
\end{table}
