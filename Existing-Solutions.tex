...
For example, \cite[Theorem 3]{huangpass:dac2015} provides the following necessary condition for any fixed-priority scheduling: 
...
Consider the task set presented in Table~\ref{table:static-example}. The usual RTA for fixed priority sporadic real-time tasks without self-suspension \cite{Liu_1973} tells us that the WCRT of a task $\tau_k$ is upper bounded by the smallest positive solution to
  \begin{equation}
   \label{eq:rta}
