...
\begin{table}[t]
  \centering
  \scalebox{0.65}{
\begin{tabular}{||C{2.5cm}|C{1cm}|C{3cm}||C{6cm}|C{6cm}|c|}  
  \hline
papers/methods & year & suspension and scheduling model& interfered task & interferring tasks & flawed\\
\hline
Rajkumar \cite{Raj:suspension1991} & 1991 & segmented, FP & \multicolumn{2}{C{12cm}|}{A period enforcer algorithm was proposed to artificially 
...
\hline 
Ding et al.\cite{DBLP:journals/ieicet/DingTT09} & 2009 &segmented, segmented FP & \multicolumn{2}{C{12cm}|}{enforcement for each computation segment, Sec.~\ref{sec:static-period-enforce}} & \checkmark\\
\hline 
...
\hline
Lakshmanan and Rajkumar~\cite{LR:rtas10} & 2010 & segmented, FP& \multicolumn{2}{C{12cm}|}{slack enforcement, Sec.~\ref{sec:slack-enforce}}&\\
\hline
Kim et al.~\cite{RTSS-KimANR13} & 2013 & segmented, segmented FP & \multicolumn{2}{C{12cm}|}{enforcement for each computation segment, Sec.~\ref{sec:static-period-enforce}} & \checkmark\\
\hline
...
\hline
Chen and Liu~\cite{RTSS-ChenL14} & 2014 & segmented (one-segment), period enforcement&  \multicolumn{2}{C{12cm}|}{speed up factor guarantee with respect to the optimal schedule, Sec.~\ref{sec:static-period-enforce}}&\\
\hline
Huang and Chen \cite{Huang:multiseg}& 2015 & segmented, FP& hybrid approaches, Sec.~\ref{sec:model-interferred-hybrid} & segmented structures with dynamic offsets, Sec.~\ref{sec:model-interfering-improving}&\\
\hline
...
\hline
Huang et al.~\cite{WC16-suspend-DATE} & 2016 & segmented, period enforcement& \multicolumn{2}{C{12cm}|}{speed up factor guarantee with respect to the optimal schedule, Sec.~\ref{sec:static-period-enforce}}&\\
\hline
\end{tabular}
}
