...
The {dynamic} self-suspension sporadic task model characterizes a task $\tau_i$ as a four-tuple $(C_i,S_i,T_i,D_i)$. As for the sporadic task model, $T_i$ denotes the 
...
fixed-priority (FP) and earliest deadline first (EDF)
scheduling as well as some of their variants. Under EDF, 
...
%  than $\tau_k$.  
\end{itemize}
We consider both type of analyses in this paper.
