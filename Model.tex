...
\begin{figure}[t]
  \centering
\def\uxfpga{0.3cm} 
\subfloat[Using FPGA in parallel (suspension aware).]{
    \scalebox{0.8}{
...
\subfloat[Not using FPGA in parallel (busy waiting).]{
   \scalebox{0.8}{
      \begin{tikzpicture}[x=\uxfpga,y=\uy,auto, thick]
        \draw[->] (0,0) -- coordinate (xaxis) (45,0) node[anchor=north]{$t$};
       \node[anchor=east] at (0, 0.75) {CPU};
