\section{Examples of Self-Suspending Task Systems}
\label{sec:examples}
...
\subsection{Examples of Dynamic Self-Suspension} 
...
\subsection{Examples of Segmented Self-Suspension} 
...
We will discuss the multiprocessor scenarios in Sections~\ref{sec:multiprocessor-HRT}~and~\ref{sec:soft-realtime}.
