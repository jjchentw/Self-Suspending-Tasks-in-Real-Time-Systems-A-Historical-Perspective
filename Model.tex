...
However, from the analysis perspective, such a  dynamic model leads to quite pessimistic results in terms of schedulability since the location of suspensions within a job is unspecified. Therefore, if the suspending patterns are well-defined and characterized with known suspending intervals, the multi-segment self-suspension task model is more appropriate.   
...
For hard real-time tasks, all the jobs should be finished before their
absolute deadlines. For soft real-time tasks, deadline misses are
