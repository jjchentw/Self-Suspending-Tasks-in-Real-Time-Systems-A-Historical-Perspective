...
As we will see in the next Section, it is possible for both the dynamic model and the segmented model to be employed simultaneously during the analysis of the same task set: for example, by using the segmented model for those tasks which are modelable acccording to it and using the dynamic model for all other tasks.
